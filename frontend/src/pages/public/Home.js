  ...
  return (
    <div className="pulse-home-page">
      ...
      <section className="pulse-hero">
        <img
          src={banner}
          className="pulse-hero-banner"
          alt="PulseArena Banner"
        />
        ...
        <div className="pulse-hero-overlay">
          <div className="pulse-hero-content">
            ...
            <p>
              Sports • eSports • Cultural • Technical Events — all in one
              premium experience built for communities.
            </p>

            <div className="pulse-hero-actions">
              <Link to="/registerTournament" className="pulse-primary-btn">
                Explore Events
              </Link>
            </div>
          </div>
      ...
      <section className="pulse-section">
        ...
        <div className="pulse-category-grid">
          {categories.map((item, index) => (
            <div className="pulse-category-card" key={index}>
              <h3>{item.title}</h3>
              <p>{item.desc}</p>
            </div>
          ))}
      ...
      <section className="pulse-section">
        <div className="pulse-section-header">
          ...
          <Link to="/registerTournament" className="pulse-link-btn">
            View All
          </Link>
        </div>
        ...
        <div className="pulse-card-row">
          {featuredEvents.map((event, index) => (
            <div className="pulse-event-card pulse-feature-card" key={index}>
              <div className="pulse-card-image-wrap">
                <img
                  src={event.image}
                  alt={event.title}
                  className="pulse-card-image"
                />
              ...
              <div className="pulse-card-footer">
                <Link to="/registerTournament" className="pulse-card-btn">
                  Explore
                </Link>
              </div>
            </div>
      ...
      <section className="pulse-section">
        ...
        <div className="pulse-card-row">
          {sportsEvents.map((event, index) => (
            <div className="pulse-event-card" key={index}>
              <div className="pulse-card-image-wrap">
                <img
                  src={event.image}
                  alt={event.title}
      ...
      <section id="about" className="pulse-home-about">
        <div className="pulse-home-info-header">
          ...
          <p>
            PulseArena helps users discover exciting experiences across sports,
            eSports, cultural, technical, and social events — all in one place.
          </p>
        </div>
      ...
      <section id="contact" className="pulse-home-contact">
        <div className="pulse-home-contact-box">
          <div className="pulse-home-contact-left">
            ...
            <p>
              Have questions, suggestions, or want to participate in upcoming
              events? We’re here to help you get started.
            </p>
          </div>
          ...
          <div className="pulse-home-contact-right">
            <div className="pulse-contact-mini-card">
              ...
              <div className="pulse-hero-actions home-contact-actions">
                ...
                <Link to="/registerTournament" className="pulse-secondary-btn white-btn">
                  Explore Events
                </Link>
              </div>
            </div>
